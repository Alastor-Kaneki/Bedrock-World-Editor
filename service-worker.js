const CACHE='bedrock-web-editor-v0.3.0';
const CORE=['./','./index.html','./styles.css','./v3.css','./app.js','./app-v3.payload.gz','./item-data.js','./item-data.payload.gz','./nbt.js','./zip.js','./leveldb-adapter.js','./manifest.webmanifest','./icon.svg'];
